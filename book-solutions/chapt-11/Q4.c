...
void user_input(int num_in_rank[NUM_RANK], int num_in_suit[NUM_SUIT], int *pairs, bool *flush, bool *straight, bool *four, bool *three);
void analyse(int num_in_rank[NUM_RANK], int num_in_suit[NUM_SUIT], int *pairs, bool *flush, bool *straight, bool *four, bool *three);
void print(int num_in_rank[NUM_RANK], int num_in_suit[NUM_SUIT], int *pairs, bool *flush, bool *straight, bool *four, bool *three);
...
int main()
{
    ...
    while(true)
    {
        user_input(num_in_rank, num_in_suit, &pairs, &flush, &straight, &four, &three);
        analyse(num_in_rank, num_in_suit, &pairs, &flush, &straight, &four, &three);
        print(num_in_rank, num_in_suit, &pairs, &flush, &straight, &four, &three);
    }
    return 0;
}
